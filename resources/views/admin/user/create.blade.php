...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto">
            ...
            <form method="POST" action="/admin/user" enctype="multipart/form-data" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input required minlength="8" id="password" name="password" type="password" class="form-control">
                    @error("password")
                    <div class="alert alert-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="equipe_joueur_id[]"
                            value="{{$uneEquipeJ->id}}" id="checkDefault">
                ...
                <div class="mb-3">
                    ...
                    <div class="my-2">
                        <a href="/admin/equipePedagogique/create" class="btn btn-primary">Ajouter une equipe
                            pédagogique</a>
                    </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="equipe_pedagogique_id[]"
                            value="{{$uneEquipeP->id}}" id="checkDefault">
                        <label class="form-check-label" for="checkDefault">
                            {{$uneEquipeP->nom}}
                        </label>
                    </div>
